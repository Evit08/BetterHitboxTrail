...
Gets the active GameManager
 ...
 @returns The current instance pointer of the GameMana     * @note[short] MacOS (ARM): Out of line
...
Updates the GameManager for the current frame.
 ...
 @param dt Delta time (Time elapsed between the last frame and the current o     * @note[short] MacOS (ARM): 0x312910
...
Initializes the GameManager.
 ...
 @returns A true or false value for whether initialization was successful or n     * @note[short] MacOS (ARM): 0x300194
    ...
    /**
When the client's account status is changed (e.g. logged in or logged out), this will be call     * @note[short] MacOS (ARM): 0x30cb20
...
Gets the ID for one of the client's current icons.
 ...
 @returns Icon     * @note[short] MacOS (ARM): 0x308b74
    ...
    /**
Performs a "Quick Save" and saves the progress of the clie     * @note[short] MacOS (ARM): 0x312834
...
Gets the icon ID for the client's current ball icon.
 ...
 @returns Icon     * @note[short] MacOS (ARM): Out of line
     * @note[short] MacOS (Intel): Out of line
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Out of line
...
Gets the color ID for the client's current primary color.
 ...
 @returns Color     * @note[short] MacOS (ARM): Out of line
     * @note[short] MacOS (Intel): Out of line
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Out of line
...
Gets the death effect ID for the client's current death effect.
 ...
 @returns Death effect     * @note[short] MacOS (ARM): Out of line
     * @note[short] MacOS (Intel): Out of line
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Out of line
...
Gets the "Glow Enabled" state for the client's icons.
 ...
 @returns Glow enabled st     * @note[short] MacOS (ARM): Out of line
     * @note[short] MacOS (Intel): Out of line
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Out of line
...
Gets the ID for the client's current streak/trail.
 ...
 @returns Streak     * @note[short] MacOS (ARM): Out of line
     * @note[short] MacOS (Intel): Out of line
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Out of line
...
Gets the active PlayLayer. Returns nullptr if none.
 ...
 @returns PlayLayer poin     * @note[short] MacOS (ARM): Out of line
     * @note[short] MacOS (Intel): Out of line
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Out of line
