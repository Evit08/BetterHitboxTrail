...
public:
    ...
    /**
@param downloadLinkOverride The user-friendly page URL for the s     * @note[short] MacOS (ARM): 0x4ddfe4
    ...
    /**
@param downloadLinkOverride The user-friendly page URL for the s     * @note[short] MacOS (ARM): 0x4e0e50
