...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ObjectDecoder> : ModifyBase<ModifyDerive<Der, ObjectDecoder>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ObjectDecoder, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ObjectDecoder, setDelegate, ObjectDecoderDelegate*)
		}
	};
}
