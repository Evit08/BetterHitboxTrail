...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCFileUtils> : ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(cocos2d::CCFileUtils, getWritablePath, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(cocos2d::CCFileUtils, isFileExist, gd::string const&)
